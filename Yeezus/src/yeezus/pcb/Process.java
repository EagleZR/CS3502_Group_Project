...
public class Process {
	...
	/**
	 * Constructs a Process with the given characteristics.
	 *
	 ...
	 */
	Process( int pid, int startInstructionAddress, int endInstructionAddress, int startInputBufferAddress,
	...
	/**
	 * Retrieves the start address of this process's instructions on the disk.
	 *
	 * @return The start address of this process's instructions on the disk.
	 */
	...
	/**
	 * Retrieves the end address of this process's instructions on the disk.
	 *
	 * @return The end address of this process's instructions on the disk.
	 */
	...
	/**
	 * Retrieves the start address of this process's input buffer on the disk.
	 *
	 * @return The start address of this process's input buffer on the disk.
	 */
	...
	/**
	 * Retrieves the end address of this process's input buffer on the disk.
	 *
	 * @return The end address of this process's input buffer on the disk.
	 */
	...
	/**
	 * Retrieves the start address of this process's output buffer on the disk.
	 *
	 * @return The start address of this process's output buffer on the disk.
	 */
	...
	/**
	 * Retrieves the end address of this process's output buffer on the disk.
	 *
	 * @return The end address of this process's output buffer  on the disk.
	 */
	...
	/**
	 * Retrieves the start address of this process's temp buffer on the disk.
	 *
	 * @return The start address of this process's temp buffer  on the disk.
	 */
	...
	/**
	 * Retrieves the end address of this process's temp buffer on the disk.
	 *
	 * @return The end address of this process's temp buffer  on the disk.
	 */
	...
	/**
	 * Retrieves the elapsed amount of time that this process has been waiting to be run on the CPU.
	 *
	 * @return the elapsed amount of time this process has been waiting on the CPU.
	 */
	...
	/**
	 * Retrieves the elapsed amount of time that this process has been running on the CPU.
	 *
	 * @return the elapsed amount of time this process has been running on the CPU.
	 */
