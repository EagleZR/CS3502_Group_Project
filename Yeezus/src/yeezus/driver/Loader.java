...
public class Loader {
    ...
    Loader(TaskManager processList, File programFile, Memory disk) throws InvalidAddressException, DuplicatePIDException, InvalidWordException, IOException {
        ...
        while (currentLine != null) {
            if (currentLine.contains("//")) {
                if (currentLine.contains("JOB")) {
                    ...
                    instructionsLength = Integer.decode("0x" + subLine.substring(0, space)); //grabs the fuckin number
                ...
                if (currentLine.contains("END")) {
                    processList.addPCB(pid, startInstructionAddress, instructionsLength, startInputBufferAddress,
                            inputBuffSize, startOutputBufferAddress, outputBuffSize,
                            startTempBufferAddress, tempBuffSize, priority);
                }
